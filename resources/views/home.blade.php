            ...
            <div class="col-md-12 table-responsive">
                <table class="table table-sm">
                    <thead class="thead-light">
                        <tr>
                            <th scope="col" class="ean">EAN:
                                <a href="{{ route('home.sort', ['name' => 'ean']) }}">
                                    <i class="fa fa-sort-down"></i>
                                </a>
                            </th>
                            <th scope="col" class="title">
                                Title:
                                <a href="{{ route('home.sort', ['name' => 'title']) }}">
                                    <i class="fa fa-sort-down"></i>
                                </a>
                            </th>
                            <th scope="col" class="platform">Platform:
                                <a href="{{ route('home.sort', ['name' => 'plat']) }}">
                                    <i class="fa fa-sort-down"></i>
                                </a>
                            </th>
                            <th scope="col" class="release">Release:
                                <a href="{{ route('home.sort', ['name' => 'release']) }}">
                                    <i class="fa fa-sort-down"></i>
                                </a>
                            </th>
                            ...
                            <th scope="col" class="publisher">
                                Publisher:
                                <a href="{{ route('home.sort', ['name' => 'pub']) }}">
                                    <i class="fa fa-sort-down"></i>
                                </a>
                            </th>
                            <th scope="col" class="stock">Stock:
                                <a href="{{ route('home.sort', ['name' => 'stock']) }}">
                                    <i class="fa fa-sort-down"></i>
                                </a>
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td Data-label="Release date:" class="align-middle text-right release">{{ isset($product->release_date) ?  $product->release_date : '-'}}</td>
                            <td Data-label="Order deadline:" class="align-middle text-right preorders">2018-03-15</td>
                            <td Data-label="Publisher:" class="align-middle text-right publisher">{{ isset($product->publisher->name) ? $product->publisher->name : '-' }}</td>
